  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        >
          <h1 className="text-5xl md:text-7xl font-[650] text-black mb-4 leading-relaxed">
            Adventure <br />
            <span>of </span>
            <span className="text-text-primary">Delicacies</span>
          </h1>

          <p className="text-lg text-gray-400 mb-16 max-w-md leading-relaxed pb-6">
      ...
      {/* Features Section */}
      <section className="py-8 bg-gray-50 px-10 rounded-[20px] mt-10 flex flex-row items-center justify-between">
      ...
      <section className="py-16 px-10">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-[650] text-black mb-4 leading-snug">
            Join our thriving <span className="text-text-primary">community</span>
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Discover amazing statistics about our growing community of food enthusiasts
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-black mb-2">{appStats.totalRecipes}</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-black mb-2">{appStats.totalUsers}</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-black mb-2">{appStats.totalRatings}</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-black mb-2">{appStats.totalFavorites}</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-black mb-2">{appStats.avgRating}</div>
      ...
      <section className="py-16 px-10 bg-gray-50 rounded-[20px] my-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6 max-w-6xl mx-auto">
          {categoryStats.map((category) => (
            <Link
              ...
              className="group"
            >
              <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                <div className="flex justify-center mb-4">
                ...
                <p className="text-gray-500 text-sm">{category.count} recipes</p>
              </div>
            </Link>
          ))}
        </div>
        ...
        <div className="text-center mt-8">
          <Link href="/recipes">
            <Button
              variant="outline"
              className="rounded-full px-8 py-2 bg-white border-gray-200 hover:bg-gray-50"
            >
              View All Recipes
      ...
      <section className="py-16 px-10">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg">Top-rated recipes from our community</p>
          </div>
          <Link href="/recipes">
            <Button
              variant="outline"
      ...
      <section className="py-16 px-10 bg-gray-50 rounded-[20px] my-10">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg">Fresh recipes just added to our collection</p>
          </div>
          <Link href="/recipes">
            <Button
              variant="outline"
      ...
      <section className="py-16 px-10">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg">Most favorited recipes this month</p>
          </div>
          <Link href="/recipes">
            <Button
              variant="outline"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {topAuthors.map((author) => (
              <div key={author.id} className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-all duration-200">
                <div className="flex justify-center mb-4">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">{author.username}</h3>
      ...
      <section className="py-16 px-10">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-[650] text-black mb-4 leading-snug">
            Become a true <span className="text-text-primary">chef</span> <br /> with our recipes.
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
            Start your culinary journey today. Share your favorite recipes and discover new flavors from around the world.
          </p>
          <Link href="/add-recipe">
            <Button
              size="lg"
