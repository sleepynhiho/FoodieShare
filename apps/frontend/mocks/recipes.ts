...
export const recipes: Recipe[] = [
  {
    ...
    steps: [
      ...
      {
        title: "Cook bacon",
        description: "Fry bacon in a pan over medium heat until crispy.",
      },
      {
        title: "Prepare sauce",
        description: "Whisk eggs with grated Parmesan until smooth and creamy.",
      },
      {
        title: "Combine pasta & bacon",
        description: "Drain pasta and mix with crispy bacon in the pan.",
      },
      {
        title: "Finish with sauce",
        description:
          "Remove pan from heat and stir in egg mixture. Season with salt & pepper.",
      },
    ],
    authorId: 1,
    ...
    steps: [
      {
        ...
        description: "Combine flour, cocoa powder, and sugar.",
      },
      {
        title: "Add wet ingredients",
        description: "Stir in butter, eggs, and milk until smooth.",
      },
      {
        title: "Bake",
        description:
          "Pour batter into a cake tin and bake at 180°C for 30 minutes.",
      },
      {
        title: "Cool & serve",
        description: "Allow cake to cool before slicing and serving.",
      },
    ],
    authorId: 2,
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Cook chicken",
        description: "Grill chicken breast until fully cooked, then slice.",
      },
      {
        title: "Assemble salad",
        description: "Toss lettuce with Caesar dressing.",
      },
      {
        title: "Add toppings",
        description: "Top salad with croutons, Parmesan, and sliced chicken.",
      },
    ],
    authorId: 3,
    ...
    steps: [
      {
        ...
        description: "Chop tomatoes, onion, and garlic.",
      },
      {
        title: "Sauté",
        description: "Cook onion and garlic in olive oil until fragrant.",
      },
      {
        title: "Simmer",
        description: "Add tomatoes and vegetable stock. Simmer for 20 minutes.",
      },
      {
        title: "Blend & season",
        description: "Blend until smooth and adjust seasoning to taste.",
      },
    ],
    authorId: 2,
  ...
  },
  {
    ...
    steps: [
      {
        title: "Prepare vegetables",
        description: "Dice carrot and chop spring onions.",
      },
      {
        title: "Scramble eggs",
        description: "Cook eggs in a hot wok until just set, then set aside.",
      },
      {
        title: "Stir-fry rice",
        description:
          "Add rice, peas, carrot, and soy sauce. Stir-fry for 5 minutes.",
      },
      {
        title: "Combine ingredients",
        description:
          "Add scrambled eggs and spring onion. Mix well and serve hot.",
      },
    ],
    authorId: 1,
